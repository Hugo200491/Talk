...
export default function App({route}) {
    ...
    const {realname} = route.params;
    const {id} = route.params;
    const {nameofconv} = route.params;

    const chatsRef = db.collection(nameofconv)


    const [user, setUser] = useState({_id: id, name: realname, avatar: avatarurl})
